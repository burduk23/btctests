...
- **Настройка подтверждений**: Уведомления при 0 (unconfirmed), 1 (если цель > 1) и целевом количестве подтверждений (настраивается индивидуально для каждого адреса). Интеллектуальная система фильтрации предотвращает повторные уведомления.
